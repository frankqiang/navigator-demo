...
var data_value = window.localStorage.getItem('data');
console.log(data_value);
var dataArray = JSON.parse(data_value);
console.log(dataArray);
var hashMap = dataArray || [{ logo: 'A', url: 'https://www.acfun.cn' }, { logo: 'B', url: 'https://www.bilibili.com' }];
var simplifyUrl = function simplifyUrl(url) {
    return url.replace('https://', '').replace('www.', '').replace(/\/.*/, ''); //正则表达式，删除'/'后面的所有内容
};
...
//# sourceMappingURL=main.05fa05d6.map